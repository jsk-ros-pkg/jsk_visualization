...
#include <QtWidgets>
#include <jsk_rviz_plugins/msg/record_command.hpp>
#endif
...
namespace jsk_rviz_plugins
{
  ...
  public Q_SLOTS:
    ...
    void setTopic( const QString& topic ) { (void)topic; }
  ...
  protected:
    ...
    rclcpp::Publisher<jsk_rviz_plugins::msg::RecordCommand>::SharedPtr pub_;
