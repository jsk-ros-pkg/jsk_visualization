...
private:
  ...
  //typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2, jsk_pcl_ros::BoundingBoxArray> SyncPolicy;
  ...
  ros::NodeHandle nh_;
  ros::NodeHandle pnh_;
  ros::Publisher pub_marker_pose_, pub_click_point_, pub_left_click_;
