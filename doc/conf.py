...
htmlhelp_basename = 'jsk_visualizationdoc'
...
man_pages = [
    (master_doc, 'jsk_visualization', u'jsk_visualization Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'jsk_visualization', u'jsk_visualization Documentation',
   author, 'jsk_visualization', 'One line description of project.',
   'Miscellaneous'),
]
